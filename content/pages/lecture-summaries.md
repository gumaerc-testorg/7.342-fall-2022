...
\*Ackerman, S. *Discovering the Brain.* Washington (DC): National Academies Press (US); 1992. "{{% resource_link "a5a18ea6-d5a4-441a-90f7-ce4e7cb81e04" "6, The Development and Shaping of the Brain" %}}." Available from: {{% resource_link "a5a18ea6-d5a4-441a-90f7-ce4e7cb81e04" "https://www.ncbi.nlm.nih.gov/books/NBK234146/" %}}

\*\*Huttenlocher, PR. "{{% resource_link "9042931a-f524-4259-92c0-002f8c75314f" "Synaptic density in human frontal cortex - developmental changes and effects of aging" %}}." *Brain Res.* 1979 Mar 16;163(2):195-205. doi: 10.1016/0006-8993(79)90349-4. PMID: 427544.
...
This week, we explore synaptic changes associated with learning. In Johnson et al*.* (2016)*,* we will focus on learning-induced gain and loss of boutons, which represent the pre-synaptic side of synapses, on long-range axons projecting from the orbitofrontal cortex (OFC) to dorsomedial prefrontal cortex (dmPFC), both regions implicated in rule learning. Johnson et al. (2016) show that learning a decision-making task modifies synaptic connections between OFC and dmPFC.  
